...
public class DataxJsonHelper implements DataxJsonInterface {
    ...
    public Map<String, Object> buildCore() {
        ...
        speedMap.putAll(ImmutableMap.of("record", 0, "byte", 1048576));
        coreMap.put("speed", speedMap);
        channelMap.put("channel", coreMap);
        res.put("transport", channelMap);
        return res;
    }
    ...
    public Map<String, Object> buildSetting() {
        ...
        errorLimitMap.putAll(ImmutableMap.of("record", 0, "percentage", 1));
